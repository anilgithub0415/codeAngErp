...
//   getClientPOs(){
//     this.clientPurchaseService.getClientPOs(this.tenantId,10000).subscribe(clientpos=>{
...
//   // Clone and force real Date parsing directly inside the mapped object
//   this.model = {
//     ...selectedRecord,
//     poDate: selectedRecord.poDate ? new Date(selectedRecord.poDate) : null,
//     requestedDeliveryDate: selectedRecord.requestedDeliveryDate ? new Date(selectedRecord.requestedDeliveryDate) : null
//   };

//   // Force your Reactive form group to physically inherit the update
//   if (this.form) {
