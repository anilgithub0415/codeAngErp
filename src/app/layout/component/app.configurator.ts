...
export class AppConfigurator implements OnInit {
    ...
    primaryColors = computed<SurfacesType[]>(() => {
        const activePreset = this.layoutService.layoutConfig().preset || 'Aura';
    ...
    ngOnInit() {
        if (isPlatformBrowser(this.platformId)) {
            const activePresetName = this.layoutService.layoutConfig().preset || 'Aura';
    ...
    updateColors(event: any, type: string, color: any) {
        ...
        // Explicitly fire database update upon interactive change
        this.layoutService.saveUserPreferences();
